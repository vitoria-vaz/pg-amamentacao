...
ATRIBUTOS_PARA_EXCLUIR = [
    ...
    'k04_prenatal_semanas', 'h01_semanas_gravidez', 'k05_prenatal_consultas', 'inicio_precoce_amamentacao',
    'k248_utilizou_nao', 'k249_utilizou_nao_sabe', 'k01_gestacoes', 'vd_ebia_escore', 'tempo_1a_amament'
]
